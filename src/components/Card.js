...
export default function Card({ title, location, googleMapsUrl, date, description, imageUrl }) {
    return(
        <section className='card'>
            ...
            <div className='details-container'>
                ...
                <svg  className='pin' viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
